...
\delta I(v)=\int _{\Omega} (\frac{\partial v}{\partial x_1}\cdot \delta \frac{\partial v}{\partial x_1}+...+\frac{\partial v}{\partial x_n}\cdot   \delta \frac{\partial v}{\partial x_n}-f(x)\delta      v(x)   )dx
\end{equation}
Using the integration by parts method for several items on the left,
\begin{equation}. \label{int_by_parts}
\int _{\Omega}\frac{\partial v}{\partial x_1}\cdot \delta \frac{\partial v}{\partial x_1} dx= \frac{\partial v}{\partial x_1}\cdot \delta v|_{\partial \Omega}-\int_{\Omega}\delta v \cdot \frac{\partial^2 v}{\partial x_1 ^2}dx=-\int_{\Omega}\delta v \cdot \frac{\partial^2 v}{\partial x_1 ^2}
\end{equation}
Substituting (\ref{int_by_parts}) to (\ref{d_I})
\begin{equation}
...
where
\begin{equation} 
I(u)=\int_\Omega(\frac{1}{2}|\nabla u(x)|^2-f(x)u(x))dx. \label{I_equ}
\end{equation}
...
\begin{equation}
s_i=\phi(W_{i2}\phi(W_{i1}s_{i_1}+b_{i1})+b_{i2})+s_{i-1}.\label{res_equ}
\end{equation}
\thispagestyle{empty}
% 流程图定义基本形状
	\begin{figure}
...
\end{equation}
Where $\gamma\int_{\Omega}|\Delta u(x)|^2dx$ is the regular term and we choose $\gamma=500$
